...
class CoordinateSystem:
    ...
    parser applies, keeping rendered maps pixel-identical.
    """
    ...
    @classmethod
    def for_map(cls, map_data: MapData, scale: float) -> CoordinateSystem:
    ...
    def to_image(self, point: MapPoint) -> tuple[float, float]:
        ...
        return grid_x * self.scale, (self.grid_height - grid_y - 1) * self.scale
